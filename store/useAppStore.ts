...
interface AppState {
  ...
  updateCanvasProject?: (id: string, data: any | ((prev: any) => any)) => void; 
    // ✨ 新增画布全局设置
  canvasSettings: { defaultLLMModel: string; defaultImageModel: string; defaultVideoModel: string; globalPromptSuffix: string; globalAssetPromptPrefix: string; globalRatio: string; directorGenre: string; directorTempo: string; };
